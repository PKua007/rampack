...
private:
    ...
    [[nodiscard]] bool isCellUsed(std::size_t cellNo) const;
    void markCellUsed(std::size_t cellNo);
...
public:
    ...
    void resetCellTracker();
    void dumpCellUsage(std::ostream &out) const;
