...
PolysphereWedgeTraits::generateGeometry([[maybe_unused]] LegacyTag<0, 0, 0> tag, std::size_t sphereNum,
                                        double smallSphereRadius, double largeSphereRadius, double spherePenetration)
{
    Expects(sphereNum >= 2);
