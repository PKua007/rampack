...
TEST_CASE("PairDensityCorrelation") {
    ...
    REQUIRE_CALL(*enumerator, enumeratePairs(_, _, _))
        ...
        .SIDE_EFFECT (
            _3.consumePair(_1, {0, 0}, {1.5, 0, 0}, _2);   // REJECTED because 0 = 0
            _3.consumePair(_1, {0, 1}, {2.5, 0, 0}, _2);   // ends in BIN 2
            _3.consumePair(_1, {0, 2}, {3.5, 0, 0}, _2);   // ends in BIN 2
    ...
    REQUIRE_CALL(*enumerator, enumeratePairs(_, _, _))
        ...
        .SIDE_EFFECT (
            _3.consumePair(_1, {0, 1}, {1.5, 0, 0}, _2);  // ends in BIN 1
            _3.consumePair(_1, {1, 2}, {2.3, 0, 0}, _2);  // ends in BIN 2
        );
    REQUIRE_CALL(*enumerator, getExpectedNumOfMoleculesInShells(_, binDividers))
        .LR_WITH(&_1 == &packing2)
