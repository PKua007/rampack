...
TEST_CASE("PairAveragedCorrelation") {
    ...
    REQUIRE_CALL(*enumerator, enumeratePairs(_, _, _))
            ...
            .SIDE_EFFECT (
                    _3.consumePair(_1, {0, 0}, 1.5);   // ends in BIN 1 with value 1
                    _3.consumePair(_1, {0, 2}, 1.8);   // ends in BIN 1 with value 2
    ...
    REQUIRE_CALL(*enumerator, enumeratePairs(_, _, _))
            ...
            .SIDE_EFFECT (
                    _3.consumePair(_1, {0, 1}, 1.5);  // ends in BIN 1 with value 3
                    _3.consumePair(_1, {1, 2}, 2.5);  // ends in BIN 2 with value 4
            );
