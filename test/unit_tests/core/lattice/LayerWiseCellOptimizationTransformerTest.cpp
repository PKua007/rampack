...
TEST_CASE("LayerWiseCellOptimizationTransformer: 3 layers") {
    ...
    PolysphereTraits::PolysphereShape shape({{{0, 0, 0}, 2}, {{0, 0, -3}, 1}},
                                            {0, 0, -1}, {0, 1, 0}, {0, 0, -1}, volume);
...
TEST_CASE("LayerWiseCellOptimizationTransformer: 1 layer") {
    ...
    double volume = 1; // volume is not important, we are laze and pick arbitrary number
    PolysphereTraits::PolysphereShape shape({{{0, 0, 0}, 0.5}, {{0, 0, 1}, 0.5}},
                                            {0, 0, 1}, {0, 1, 0}, {0, 0, 0}, volume);
    PolysphereTraits traits(shape);
